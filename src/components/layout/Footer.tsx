            ...
            <div className="flex gap-6">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="text-black hover:text-slate-400 transition-colors flex items-center gap-2 text-[10px] font-black uppercase tracking-widest focus-visible:ring-2 focus-visible:ring-black outline-none rounded-sm"
                >
