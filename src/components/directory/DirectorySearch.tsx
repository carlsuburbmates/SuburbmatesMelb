        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              aria-label="Search businesses, services, or products"
              value={search}
          ...
          <div className="relative">
            ...
            <input
              ...
              aria-label="Enter Melbourne suburb"
              value={suburb}
        ...
        <div className="flex flex-wrap gap-2">
          {['Tutoring', 'Consulting', 'Fitness', 'Design', 'Photography', 'Marketing'].map((term) => (
            <button
              ...
              className="px-3 py-1 text-sm bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:outline-none"
            >
              {term}
            </button>
          ))}
