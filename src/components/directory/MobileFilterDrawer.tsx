...
export function MobileFilterDrawer({
  ...
  // Prevent body scroll when open and add Escape key listener
  useEffect(() => {
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <h3 id="filter-drawer-title" className="text-lg font-bold text-gray-900">Filters</h3>
              <button
                onClick={onClose}
                className="p-2 -mr-2 text-gray-500 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 rounded-lg"
