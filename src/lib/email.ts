...
export async function sendTierDowngradeEmail(params: {
  ...
  return sendEmail({
    ...
    html: `
      ...
      <p>${safeBusinessName} was downgraded from <strong>${params.oldTier.toUpperCase()}</strong> to <strong>${params.newTier.toUpperCase()}</strong>.</p>
...
export async function sendOrderConfirmationEmail(
  ...
  return sendEmail({
    to: email,
    subject: `Order Confirmation - ${safeProductTitle}`,
    html: `
...
export async function sendNewOrderNotificationEmail(
  ...
  return sendEmail({
    to: email,
    subject: `New Order - ${safeProductTitle}`,
    html: `
...
export async function sendRefundRequestEmail(
  ...
  return sendEmail({
    to: email,
    subject: `Refund Request - ${safeProductTitle}`,
    html: `
...
export async function sendRefundConfirmationEmail(
  ...
  return sendEmail({
    to: email,
    subject: `Refund Processed - ${safeProductTitle}`,
    html: `
...
export async function sendFeaturedSlotExpiryEmail(
  ...
  return sendEmail({
    to: email,
    subject: `Featured Slot Expiring Soon - ${safeSuburb}`,
    html: `
