...
// Initialize Resend client (use placeholder if missing during build to prevent crash)
const resendApiKey = process.env.RESEND_API_KEY || (process.env.NODE_ENV === 'production' ? 're_build_placeholder' : 're_test_mock');
