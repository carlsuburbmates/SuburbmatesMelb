...
// Use a placeholder key if environment variable is missing (e.g. during build)
// The API calls will fail if used, but this allows the client to be instantiated
