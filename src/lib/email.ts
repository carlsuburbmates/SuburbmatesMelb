...
// Initialize Resend client (fallback for build phase)
const apiKey = process.env.RESEND_API_KEY || (process.env.NEXT_PHASE === 'phase-production-build' ? 're_build_fallback' : undefined);
