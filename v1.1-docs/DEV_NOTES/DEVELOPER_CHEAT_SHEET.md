...
4. Best practices → reference only
...
**Not allowed from external sources:**

- Database query code from incompatible systems
- Backend procedure code from other frameworks
- Authentication context/middleware from other systems
- Refund/dispute handling logic that conflicts with V1.1
- Merchant-of-record assumptions
- ORM-based queries from other systems
...
```
No external project directories should be imported or referenced in the V1.1 codebase.
```
...
→ Check no forbidden external code imports found
