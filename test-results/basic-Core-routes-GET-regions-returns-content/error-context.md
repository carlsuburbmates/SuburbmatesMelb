...
- Name: basic.spec.ts >> Core routes >> GET /regions returns content
- Location: tests/e2e/basic.spec.ts:7:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3010/regions
Call log:
  - navigating to "http://localhost:3010/regions", waiting until "domcontentloaded"
