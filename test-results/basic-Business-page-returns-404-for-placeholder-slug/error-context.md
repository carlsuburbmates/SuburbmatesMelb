...
- Name: basic.spec.ts >> Business page returns 404 for placeholder slug
- Location: tests/e2e/basic.spec.ts:34:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3010/business/test-slug
Call log:
  - navigating to "http://localhost:3010/business/test-slug", waiting until "domcontentloaded"
