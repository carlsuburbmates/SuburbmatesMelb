...
- Name: basic.spec.ts >> Core routes >> GET /robots.txt returns content
- Location: tests/e2e/basic.spec.ts:7:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3010/robots.txt
Call log:
  - navigating to "http://localhost:3010/robots.txt", waiting until "domcontentloaded"
