-- Migration 014: Reconcile featured_slots schema to Stage-3 expectations (Fixed)
BEGIN;
...
-- Add foreign key constraints if referencing tables exist and fk not present (fixed syntax)
DO $$
BEGIN
